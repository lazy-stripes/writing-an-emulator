...
// https://blog.tigris.fr/2021/06/17/writing-an-emulator-sound-will-do/
...
func NewSDL() *SDL {
	...
	window, err := sdl.CreateWindow("Sound will do",
...
type SquareWave struct {
	...
	NR14 uint8 // Control and frequency's higher 3 bits
...
// When an unknown opcode is encountered, quit.
//
////////////////////////////////////////////////////////////////////////////////
